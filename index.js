...
function buttonator() {
  ...
  document.getElementById(`desc${buttonnumber}`).innerHTML += `<figcaption class="gunstuff" id="type${buttonnumber}">Primary /<span class="guncolor" id="color${buttonnumber}">/Primary</span></figcaption>`
}
