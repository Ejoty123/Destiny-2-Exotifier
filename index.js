...
function buttonator() {
  ...
  document.getElementById("table").innerHTML +=
            `<figure><img id="image${buttonnumber}" class="imagecontainer" src="https://www.bungie.net/common/destiny2_content/icons/0f3e38e82bac5e8c78d1a47be53341e0.jpg" alt="placeholder weapon"><div class="description"><figcaption class="gunname" id="${buttonnumber}">PLAYER ${buttonnumber}</figcaption></div><div class="guntype"><figcaption id="type${buttonnumber}"></figcaption><span class="guncolor" id="color${buttonnumber}"></span></div>`;
}
